...
public class BadgesTest
{
    ...
    public void Test_Update_Badge_01()
    {
        ...
        badgeNotification.UpdateBadgeCount("Root|Mails|Rewarded", -1);
        var badge = badgeNotification.GetBadge("Root|Mails|Rewarded");
        Assert.AreEqual(0, badge.badgeCount);

        badgeNotification.UpdateBadgeCount("Root|Mails|System", 4);
        badge = badgeNotification.GetBadge("Root|Mails|System");
        Assert.AreEqual(4, badge.badgeCount);
        Assert.AreEqual(4, badgeNotification.GetBadgeCount("Root|Mails"));
    }
    ...
    public void Test_Update_Badge_02()
    {
        ...
        BadgeNotificationBase<int> badgeNotification = new BadgeNotification(badgeGraph);
        badgeNotification.AddBadge("Root|Mails|Secrete", 1);
        badgeNotification.UpdateBadgeCount("Root|Mails|Secrete", 1);
        var badge = badgeNotification.GetBadge("Root|Mails|Secrete");
    ...
    public void Test_Update_Badge_03()
    {
        ...
        badgeNotification.UpdateBadgeCount("Root|Quests|Daily|0", -1);
    ...
    public void Test_Get_Badge_Value_01()
    {
        ...
        badgeNotification.UpdateBadgeCount("Root|Mails|Rewarded", -11);
    ...
    public void Test_Get_Badge_Value_02()
    {
        ...
        badgeNotification.UpdateBadgeCount("Root|Mails|System", 1);
        Assert.AreEqual(1, badgeNotification.GetBadgeCount("Root|Mails|System"));
        badgeNotification.UpdateBadgeCount("Root|Mails|Rewarded", 4);
    ...
    public void Test_Update_Badges_01()
    {
        ...
        badgeNotification.UpdateBadgesCount(prefix, 1);
        ...
        badgeNotification.UpdateBadgesCount("Root|Characters|1|UpE|Sword", 1);
        ...
        badgeNotification.UpdateBadgesCount("Root|Characters|1|UpE|Horse", -1);
    ...
    public void Test_Update_Badges_With_Postfix_01()
    {
        ...
        var postfix = "Sword";
        badgeNotification.UpdateBadgesCount("Root|Characters", postfix, 2);
    ...
    public void Test_Update_Badges_03()
    {
        ...
        badgeNotification.UpdateBadgesCount(prefix, postfix, 4);
        equip_Slot1 = badgeNotification.GetBadgeCount("Root|Characters|1|Equip|Sword");
        Assert.AreEqual(5, equip_Slot1);
        characters = badgeNotification.GetBadgeCount("Root|Characters");
        Assert.AreEqual(26, characters);

        badgeNotification.UpdateBadgesCount(prefix, postfix, -1);
        equip_Slot1 = badgeNotification.GetBadgeCount("Root|Characters|1|Equip|Sword");
        ...
        badgeNotification.UpdateBadgesCount(prefix, postfix, -3);
        equip_Slot1 = badgeNotification.GetBadgeCount("Root|Characters|1|Equip|Sword");
    ...
    public void Test_Set_Badge_Value_01()
    {
        ...
        Assert.AreEqual(5, badge);
        badgeNotification.UpdateBadgesCount("Root|Characters", "UpC", 1);
    ...
    public void Test_Use_Case_01()
    {
        ...
        badgeNotification.UpdateBadgeCount("Root|Characters|0|Equip|Sword", -1);
        ...
        //upgrade character 1
        badgeNotification.UpdateBadgeCount("Root|Characters|1|UpC", 2);
